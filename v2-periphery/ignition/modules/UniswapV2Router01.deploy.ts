...
const UniswapV2Router01Module = buildModule("UniswapV2Router01Module", (m) => {
  ...
  const router = m.contract("UniswapV2Router01", [factoryAddress, wethAddress]);

  // Return deployed contract instance
  return { router };
});

export default UniswapV2Router01Module;
